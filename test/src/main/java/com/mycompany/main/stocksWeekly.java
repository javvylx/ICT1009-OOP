 ...
 */
public class stocksWeekly extends stocksInfo{
    
    private String open, high, low, close, volume, dateTime;

    public stocksWeekly(String info, String symbol, String lastRef, String interval, String outputsize, String timeZone,
