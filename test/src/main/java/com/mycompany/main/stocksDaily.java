 ...
 */
public class stocksDaily extends stocksInfo {
    
    private String open, high, low, close, volume, dateTime;

    public stocksDaily(String info, String symbol, String lastRef, String interval, String outputsize, String timeZone,
