...
/**
 * Java Object - stocksHourly
 * 
 * Parents class - stocksInfo
 * Child class - stocksHourly, stocksDaily, stocksWeekly, stocksMonthly
 * 
 * super(info, symbol, lastRef, interval, outputsize, timeZone) is called from parent class
 * 
 ...
 */
public class stocksHourly extends stocksInfo{

    private String open, high, low, close, volume, dateTime;

    public stocksHourly(String info, String symbol, String lastRef, String interval, String outputsize, String timeZone,
